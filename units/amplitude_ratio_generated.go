...
var internalAmplitudeRatioUnitsMap = map[AmplitudeRatioUnits]bool{
	
	AmplitudeRatioDecibelVolt: true,
	AmplitudeRatioDecibelMicrovolt: true,
	AmplitudeRatioDecibelMillivolt: true,
	AmplitudeRatioDecibelUnloaded: true,
}
...
func newAmplitudeRatio(value float64, fromUnit AmplitudeRatioUnits) (*AmplitudeRatio, error) {
	...
	if _, ok := internalAmplitudeRatioUnitsMap[fromUnit]; !ok {
		return nil, fmt.Errorf("unknown unit %s in AmplitudeRatioUnits", fromUnit)
	}
	a := &AmplitudeRatio{}
