...
func TestBrakeSpecificFuelConsumption_BrokenCreation(t *testing.T) {
	// Create a factory instance
	uf := units.BrakeSpecificFuelConsumptionFactory{}

	_, err := uf.CreateBrakeSpecificFuelConsumption(100, "unknown")
