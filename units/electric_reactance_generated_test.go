...
func TestGetElectricReactanceAbbreviation(t *testing.T) {
    tests := []struct {
        name string
        unit units.ElectricReactanceUnits
        want string
    }{
        {
        ...
        {
            name: "invalid unit",
            unit: units.ElectricReactanceUnits("invalid"),
            want: "",
        },
    }
    ...
    for _, tt := range tests {
        t.Run(tt.name, func(t *testing.T) {
            got := units.GetElectricReactanceAbbreviation(tt.unit)
            if got != tt.want {
                t.Errorf("GetElectricReactanceAbbreviation(%v) = %v, want %v", 
                    tt.unit, got, tt.want)
            }
        })
    }
...
func TestElectricReactance_String(t *testing.T) {
    factory := units.ElectricReactanceFactory{}
    ...
    for _, tt := range tests {
        t.Run(tt.name, func(t *testing.T) {
            unit, err := factory.CreateElectricReactance(tt.value, units.ElectricReactanceOhm)
            if err != nil {
            ...
            if !strings.HasPrefix(got, tt.want) {
                t.Errorf("ElectricReactance.String() = %v, want %v", got, tt.want)
            }
        })
    }
}
...
func TestElectricReactance_BrokenCreation(t *testing.T) {
	// Create a factory instance
	uf := units.ElectricReactanceFactory{}

	_, err := uf.CreateElectricReactance(100, "unknown")
