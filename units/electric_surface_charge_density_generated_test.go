...
func TestElectricSurfaceChargeDensity_BrokenCreation(t *testing.T) {
	// Create a factory instance
	uf := units.ElectricSurfaceChargeDensityFactory{}

	_, err := uf.CreateElectricSurfaceChargeDensity(100, "unknown")
