...
func TestGetLuminousFluxAbbreviation(t *testing.T) {
    tests := []struct {
        name string
        unit units.LuminousFluxUnits
        want string
    }{
        {
            name: "Lumen abbreviation",
            unit: units.LuminousFluxLumen,
            want: "lm",
        },
        {
            name: "invalid unit",
            unit: units.LuminousFluxUnits("invalid"),
            want: "",
        },
    }
    ...
    for _, tt := range tests {
        t.Run(tt.name, func(t *testing.T) {
            got := units.GetLuminousFluxAbbreviation(tt.unit)
            if got != tt.want {
                t.Errorf("GetLuminousFluxAbbreviation(%v) = %v, want %v", 
                    tt.unit, got, tt.want)
            }
        })
    }
...
func TestLuminousFlux_String(t *testing.T) {
    factory := units.LuminousFluxFactory{}
    ...
    for _, tt := range tests {
        t.Run(tt.name, func(t *testing.T) {
            unit, err := factory.CreateLuminousFlux(tt.value, units.LuminousFluxLumen)
            if err != nil {
            ...
            if !strings.HasPrefix(got, tt.want) {
                t.Errorf("LuminousFlux.String() = %v, want %v", got, tt.want)
            }
        })
    }
}