...
func TestRadiationEquivalentDoseRate_BrokenCreation(t *testing.T) {
	// Create a factory instance
	uf := units.RadiationEquivalentDoseRateFactory{}

	_, err := uf.CreateRadiationEquivalentDoseRate(100, "unknown")
