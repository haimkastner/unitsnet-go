...
func TestGetRelativeHumidityAbbreviation(t *testing.T) {
    tests := []struct {
        name string
        unit units.RelativeHumidityUnits
        want string
    }{
        {
        ...
        {
            name: "invalid unit",
            unit: units.RelativeHumidityUnits("invalid"),
            want: "",
        },
    }
    ...
    for _, tt := range tests {
        t.Run(tt.name, func(t *testing.T) {
            got := units.GetRelativeHumidityAbbreviation(tt.unit)
            if got != tt.want {
                t.Errorf("GetRelativeHumidityAbbreviation(%v) = %v, want %v", 
                    tt.unit, got, tt.want)
            }
        })
    }
...
func TestRelativeHumidity_String(t *testing.T) {
    ...
    for _, tt := range tests {
        t.Run(tt.name, func(t *testing.T) {
            unit, err := factory.CreateRelativeHumidity(tt.value, units.RelativeHumidityPercent)
            if err != nil {
            ...
            if !strings.HasPrefix(got, tt.want) {
                t.Errorf("RelativeHumidity.String() = %v, want %v", got, tt.want)
            }
        })
    }
}
...
func TestRelativeHumidity_BrokenCreation(t *testing.T) {
	// Create a factory instance
	uf := units.RelativeHumidityFactory{}

	_, err := uf.CreateRelativeHumidity(100, "unknown")
