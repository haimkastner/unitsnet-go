...
func TestThermalConductivityConversions(t *testing.T) {
	...
	}
	{
		...
		cacheResult := a.WattsPerMeterKelvin()
	...
	}
	{
		...
		cacheResult := a.BtusPerHourFootFahrenheit()
		if math.IsNaN(result) || cacheResult != result {
...
func TestGetThermalConductivityAbbreviation(t *testing.T) {
    tests := []struct {
        name string
        unit units.ThermalConductivityUnits
        want string
    }{
        {
        ...
        {
            name: "invalid unit",
            unit: units.ThermalConductivityUnits("invalid"),
            want: "",
        },
    }
    ...
    for _, tt := range tests {
        t.Run(tt.name, func(t *testing.T) {
            got := units.GetThermalConductivityAbbreviation(tt.unit)
            if got != tt.want {
                t.Errorf("GetThermalConductivityAbbreviation(%v) = %v, want %v", 
                    tt.unit, got, tt.want)
            }
        })
    }
...
func TestThermalConductivity_String(t *testing.T) {
    factory := units.ThermalConductivityFactory{}
    ...
    for _, tt := range tests {
        t.Run(tt.name, func(t *testing.T) {
            unit, err := factory.CreateThermalConductivity(tt.value, units.ThermalConductivityWattPerMeterKelvin)
            if err != nil {
            ...
            if !strings.HasPrefix(got, tt.want) {
                t.Errorf("ThermalConductivity.String() = %v, want %v", got, tt.want)
            }
        })
    }
}
...
func TestThermalConductivity_BrokenCreation(t *testing.T) {
	// Create a factory instance
	uf := units.ThermalConductivityFactory{}

	_, err := uf.CreateThermalConductivity(100, "unknown")
