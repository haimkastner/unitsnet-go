...
func TestVitaminAConversions(t *testing.T) {
	...
	}
	{
		...
		cacheResult := a.InternationalUnits()
...
func TestGetVitaminAAbbreviation(t *testing.T) {
    tests := []struct {
        name string
        unit units.VitaminAUnits
        want string
    }{
        {
            name: "InternationalUnit abbreviation",
            unit: units.VitaminAInternationalUnit,
            want: "IU",
        },
        {
            name: "invalid unit",
            unit: units.VitaminAUnits("invalid"),
            want: "",
        },
    }
    ...
    for _, tt := range tests {
        t.Run(tt.name, func(t *testing.T) {
            got := units.GetVitaminAAbbreviation(tt.unit)
            if got != tt.want {
                t.Errorf("GetVitaminAAbbreviation(%v) = %v, want %v", 
                    tt.unit, got, tt.want)
            }
        })
    }
...
func TestVitaminA_String(t *testing.T) {
    factory := units.VitaminAFactory{}
    ...
    for _, tt := range tests {
        t.Run(tt.name, func(t *testing.T) {
            unit, err := factory.CreateVitaminA(tt.value, units.VitaminAInternationalUnit)
            if err != nil {
            ...
            if !strings.HasPrefix(got, tt.want) {
                t.Errorf("VitaminA.String() = %v, want %v", got, tt.want)
            }
        })
    }
}
...
func TestVitaminA_BrokenCreation(t *testing.T) {
	// Create a factory instance
	uf := units.VitaminAFactory{}

	_, err := uf.CreateVitaminA(100, "unknown")
